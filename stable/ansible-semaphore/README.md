...
![Version: 14.4.0](https://img.shields.io/badge/Version-14.4.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.16.45](https://img.shields.io/badge/AppVersion-2.16.45-informational?style=flat-square)
...
|------------|------|---------|
| oci://registry-1.docker.io/cloudpirates | mariadb | 0.7.0 |
| oci://registry-1.docker.io/cloudpirates | postgres | 0.12.1 |
