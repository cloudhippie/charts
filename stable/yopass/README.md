...
![Version: 7.7.0](https://img.shields.io/badge/Version-7.7.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 12.5.0](https://img.shields.io/badge/AppVersion-12.5.0-informational?style=flat-square)
...
|------------|------|---------|
| oci://registry-1.docker.io/cloudpirates | memcached | 0.7.1 |
| oci://registry-1.docker.io/cloudpirates | redis | 0.16.5 |
