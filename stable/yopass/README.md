...
![Version: 4.8.0](https://img.shields.io/badge/Version-4.8.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 11.17.0](https://img.shields.io/badge/AppVersion-11.17.0-informational?style=flat-square)
...
|------------|------|---------|
| oci://registry-1.docker.io/bitnamicharts | memcached | 7.6.0 |
| oci://registry-1.docker.io/bitnamicharts | redis | 20.6.0 |
